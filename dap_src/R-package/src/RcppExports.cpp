...
RcppExport SEXP _dap_dap_main(SEXP input_formatSEXP, SEXP argSEXP, SEXP quietSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type input_format(input_formatSEXP);
    Rcpp::traits::input_parameter< List >::type arg(argSEXP);
    Rcpp::traits::input_parameter< int >::type quiet(quietSEXP);
    rcpp_result_gen = Rcpp::wrap(dap_main(input_format, arg, quiet));
